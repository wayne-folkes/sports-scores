export const THEMES = {
  ...
  wire: {
    ...
    vars: {
      ...
      '--bg-page-alt': '#eef0e4',
      '--bg-widget': '#eef0e4',
      '--bg-widget-strong': '#e2e4d3',
      '--bg-card': '#f6f7f0',
      '--bg-card-hover': '#eceee0',
      '--bg-soft': 'rgba(28, 36, 48, 0.04)',
      '--text-primary': '#1c2430',
      '--text-secondary': '#5b6472',
      '--text-muted': '#8890a0',
      '--border': 'rgba(28, 36, 48, 0.14)',
      '--border-strong': 'rgba(28, 36, 48, 0.28)',
      '--border-focus': '#7c6a2e',
      '--accent': '#7c6a2e',
      '--accent-dim': 'rgba(124, 106, 46, 0.12)',
      '--shadow-sm': '0 2px 10px rgba(28, 24, 16, 0.10)',
      '--shadow-md': '0 6px 20px rgba(28, 24, 16, 0.12)',
      '--shadow-lg': '0 12px 36px rgba(28, 24, 16, 0.14)',
      '--status-live': '#b73224',
      '--status-live-bg': 'rgba(183, 50, 36, 0.10)',
      '--status-live-glow': 'rgba(183, 50, 36, 0.22)',
      '--status-final': '#5b6472',
      '--status-final-bg': 'rgba(91, 100, 114, 0.12)',
      '--status-scheduled': '#7c6a2e',
      '--status-scheduled-bg': 'rgba(124, 106, 46, 0.10)',
      '--wire-live': '#b73224',
      '--wire-brass': '#7c6a2e',
      '--wire-rule': 'rgba(28, 36, 48, 0.18)',
      '--wire-rule-strong': 'rgba(28, 36, 48, 0.34)',
