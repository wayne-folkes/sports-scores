...
**Files:** `client/src/components/BoxScoreModal/BoxScoreModal.tsx`, `client/src/components/ScoreCard/ScoreCard.tsx`
...
**Files:** `client/src/components/BoxScoreModal/BoxScoreModal.tsx`
...
**Files:** `api/scores/[sport].ts`, `api/teams/[sport].ts`, `api/boxscore/[sport]/[eventId].ts`
...
`hexToRgb()`, `rgba()`, and `mixColors()` are all defined inline in `SportWidget.tsx` and cannot be reused elsewhere. Moving them to `src/utils/colors.ts` makes them testable and available to any future component that needs team color accents.

**Files:** `client/src/components/SportWidget/SportWidget.tsx`
...
**Files:** `client/src/components/TeamSelector/TeamSelector.tsx`
...
**Files:** `client/src/components/BoxScoreModal/BoxScoreModal.tsx`, `client/src/components/BoxScoreModal/BoxScoreModal.css`

---

### Consolidate magic numbers into a constants file
Scattered across the codebase:
- Poll interval `30_000` in `SportWidget.tsx`
- Cache TTLs `60`, `3600`, `30` in route files
- Skeleton count `3` in `SportWidget.tsx`

Moving these to a shared `api/_lib/config.ts` and `client/src/constants.ts` makes them easy to tune and self-documenting.

**Files:** `client/src/components/SportWidget/SportWidget.tsx`, `api/`
...
**Files:** `client/src/components/TeamSelector/TeamSelector.tsx`, `client/src/components/SportWidget/SportWidget.tsx`
